...
'''
parser = (argparse.ArgumentParser(description='Order embedding arguments') if not HYPERPARAM_SEARCH else HyperOptArgumentParser(strategy='grid_search'))
utils.parse_optimizer(parser)
parse_encoder(parser)
args = parser.parse_args()
...
model.emb_model(nagydata(torch.tensor([[0.],[1.],[1.],[2.]]),torch.tensor([[0,1,1,2],[1,2,3,3]])))
'''